          ...
          >
            <div className="relative w-full">
              <motion.div
                ...
                className="py-6 px-6 md:py-8 md:px-8 relative overflow-hidden rounded-3xl"
                style={{
                  background:
              ...
              >
                <div className="flex items-start gap-3 md:gap-4">
                  <motion.div
                    ...
                    className="p-2 md:p-3 rounded-full shadow-lg bg-gradient-to-r from-blue-400 to-blue-600"
                  >
                    <img
                      src={
                        step.title === "Design"
